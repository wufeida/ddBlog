...
class CreateConfigsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('configs', function (Blueprint $table) {
            ...
            $table->boolean('water_status')->nullable()->default(true)->comment('水印开关');
            ...
            $table->integer('article_number')->nullable()->default(10)->unsigned()->comment('文章显示条数');
            $table->string('article_sort')->nullable()->comment('文章顺序 desc倒序 asc正序');
            $table->string('article_sortColumn')->nullable()->comment('文章排序字段');
            $table->boolean('footer_github_status')->nullable()->default(true)->comment('底部github图标开关');
            $table->string('footer_github_url')->nullable()->comment('底部github图标地址');
            $table->boolean('footer_qq_status')->nullable()->default(true)->comment('底部qq图标开关');
